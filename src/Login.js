...
function Login() {
  ...
  return (
    ...
    <img src="https://www.seekpng.com/png/detail/371-3715298_advertise-on-linked-logo-no-background.png"/>
    {
      signup==true ?(
    ...
    <form onSubmit={register}>
      ...
      <h4>Alraedy a member ? <span onClick={e=>setSignUp(false)}>Login here</span></h4>
    </form>)
    :
    (
